...
namespace VulkanTest
{
	...
	private:
		static std::vector<char> readFile(const std::string& filepaht);
		...
		void createShaderModule(const std::vector<char>& code, VkShaderModule* sharderModule);

		Device& device;
		VkPipeline graphocsPipeline;
