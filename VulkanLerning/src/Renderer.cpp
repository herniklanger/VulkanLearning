...
namespace VulkanTest
{
	...
	void Renderer::BeginSwapChainRenderPass(VkCommandBuffer commandBuffer)
	{
		...
		assert(commandBuffer == getCurrentCommandBuffer() && "Can't beging render pass on command buffer from a defferent frame");
	...
	void Renderer::EndSwapChainRenderPass(VkCommandBuffer commandBuffer)
	{
		...
		assert(commandBuffer == getCurrentCommandBuffer() && "Can't end render pass on command buffer from a defferent frame");
